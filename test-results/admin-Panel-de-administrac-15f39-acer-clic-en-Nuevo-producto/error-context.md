...
- Name: admin.spec.ts >> Panel de administración >> Gestión de productos >> abre el drawer al hacer clic en Nuevo producto
- Location: __tests__\e2e\admin.spec.ts:23:9
